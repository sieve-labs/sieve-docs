...
**Report a bug**  
Open an issue on the [GitHub repository](https://github.com/sieve-sort/sieve-app/issues). Include your platform (Android, Linux, Windows, macOS), what you expected to happen, and what actually happened. Screenshots help.
...
The docs live in the [sieve-docs repository](https://github.com/sieve-sort/sieve-docs). If something is unclear, missing, or wrong, open a pull request with your changes. Documentation contributions are just markdown — no coding required.

**Contribute code**  
The app is built in Flutter. If you want to fix a bug or add a feature:

1. Fork the [sieve-app repository](https://github.com/sieve-sort/sieve-app)
